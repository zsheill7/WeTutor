//
//  NativeEventViewController.swift
//  TutorMe
//
...
class NativeEventViewController : FormViewController {
    
    class func instantiateFromStoryboard() -> NativeEventViewController {
        let storyboard = UIStoryboard(name: "MenuViewController", bundle: nil)
        return storyboard.instantiateViewController(withIdentifier: "NativeEventViewController") as! NativeEventViewController
        /*let storyboard = UIStoryboard(name: "MenuViewController", bundle: nil)
